var bananaImage, obstacleImage,obstacle_img, obstaclesGroup, backgr, backImage, score, player, player_running, ground, ground_img, FoodGroup;
var gameOver;
var score = 0;
...
function setup() {
  ...
  backgr=createSprite(110,300,800,400);
